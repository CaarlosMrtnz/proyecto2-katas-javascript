...
const names = users3_1.map(user => user.name);
...
const updatedNames = users3_2.map(user => user.name.startsWith('A') ? 'Anacleto' : user.name);
console.log('3.2', updatedNames);
