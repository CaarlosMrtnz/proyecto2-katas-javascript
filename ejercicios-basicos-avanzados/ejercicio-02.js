...
console.log('El precio total de los sables de luz ' + sable1.nombre + ' y ' + sable2.nombre + ' es de: ' + precioTotal + '\n');
...
/* const modificarVariables = precioBase => {
    return precioBase + precioBaseGlobal;
}

nave1.precioFinal = modificarVariables(nave1.precioBase);
nave2.precioFinal = modificarVariables(nave2.precioBase); */
